...
if "%AEGIS_VECTOR_SEMANTIC_SEARCH_ENABLED%"=="" set "AEGIS_VECTOR_SEMANTIC_SEARCH_ENABLED=0"
if "%AEGIS_VECTOR_SEMANTIC_WRITE_ENABLED%"=="" set "AEGIS_VECTOR_SEMANTIC_WRITE_ENABLED=0"
